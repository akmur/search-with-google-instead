...
const SearchWithGoogleInstead = (function SearchWithGoogleInstead() {
  ...
  const getEngineType = function getEngineType(url) {
    let engineType;
  ...
  const buildButtonHTML = function buildButtonHTML() {
